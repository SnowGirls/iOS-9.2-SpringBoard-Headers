...
@class AVController, NSDictionary, NSInvocation, NSString, SUICFlamesView, SiriUISuggestionsView, UILabel, UIView, VSRecognitionSession, _UIBackdropView;
...
@property(retain, nonatomic) NSInvocation *postSoundInvocation; // @synthesize postSoundInvocation=_postSoundInvocation;
